# -*- coding: utf-8 -*-
"""updated health.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1B87H6aKNUIDHmZrbfCmHKSl727l1wmzE
"""
...
# This route is now handled in the main app definition cell above to avoid endpoint conflicts.
...
with app.test_client() as client:
    # Pick the first row from X_test to simulate a user input
    ...
    if response.status_code == 200:
        ...
        # Extract results from the HTML response (basic check)
        ...
        import re
        risk_match = re.search(r'(\d+\.\d+)% Risk', html_output)
        if risk_match:
